...
bar.animate(1.0, function () {//バーを描画する割合を指定します 1.0 なら100%まで描画します
  ...
  document.getElementById('daiya1').classList.add('daiya1');
  document.getElementById('daiya2').classList.add('daiya2');
  document.getElementById('daiya3').classList.add('daiya3');
  document.getElementById('daiya4').classList.add('daiya4');
  document.getElementById('daiya5').classList.add('daiya5');
  document.getElementById('daiya6').classList.add('daiya6');
});  
